...
$(function() {
  $(".h-redesSoc-img1").hover(
    function() {
      // alert('hola1');
      $(".h-redesSoc-img1").attr("src", "img/facebook_active.png");
    },
    function() {
      $(".h-redesSoc-img1").attr("src", "img/facebook.png");
      // alert('hola2');
    }
  );
  $(".h-redesSoc-img2").hover(
    function() {
      // alert('hola1');
      $(".h-redesSoc-img2").attr("src", "img/instagram_active.png");
    },
    function() {
      $(".h-redesSoc-img2").attr("src", "img/instagram.png");
      // alert('hola2');
    }
  );
  $(".h-redesSoc-img3").hover(
    function() {
      // alert('hola1');
      $(".h-redesSoc-img3").attr("src", "img/whatsapp_active.png");
    },
    function() {
      $(".h-redesSoc-img3").attr("src", "img/whatsapp.png");
      // alert('hola2');
    }
  );
});
